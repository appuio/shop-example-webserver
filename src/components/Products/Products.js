  ...
  <Grid.Row>
    <Grid.Column width={4}>
      <Segment>
        ...
        <Dropdown placeholder="Category" fluid multiple selection options={[
        ...
        <Dropdown placeholder="License type" fluid multiple selection options={[
        ...
        <Dropdown placeholder="Publisher" fluid multiple selection options={[
