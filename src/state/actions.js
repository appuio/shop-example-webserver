...
export const productsReceive = (products) => ({ type: PRODUCTS_RECEIVE, products });

export const PRODUCTS_FAIL = 'PRODUCTS_FAIL';
export const productsFail = () => ({ type: PRODUCTS_FAIL });

export const PRODUCT_REQUEST = 'PRODUCT_REQUEST';
export const productRequest = (id) => ({ type: PRODUCT_REQUEST, id });

export const PRODUCT_RECEIVE = 'PRODUCT_RECEIVE';
export const productReceive = (product) => ({ type: PRODUCT_RECEIVE, product });
